struct HLD {
  ...
  vector<pair<int, int>> path_decomposition(int u, int v) {
    ...
    return res;
  } // returns a vector of (l, r) where l and r are idxs and segment [l, r] is a part of idxs of path from u to v
