...
/* Logic :
    ...
    we'll get the number of blocks before this block. so :
    if this block has the number that has remainder r in modula m and that number is less than or equal to n (r <= n % m)
